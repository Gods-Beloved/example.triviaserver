...
fun Route.updateUserWinningsRoute(
    app: Application,
    userDataSource: UserDataSource
) {
    authenticate("auth-session") {
        put(EndPoints.UpdateUserWinnings.path) {
...
private suspend fun PipelineContext<Unit, ApplicationCall>.updateUserWinnings(
    app: Application,
    userId: String,
    balanceUpdate: BalanceUpdate,
    userDataSource: UserDataSource
) {
    val response = userDataSource.updateWinnings(
        userId = userId,
